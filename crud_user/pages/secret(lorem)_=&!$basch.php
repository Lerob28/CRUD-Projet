<?php 
	include('headerConnexionAdmin.php');
...
?>
			<div class="row ">
				<div class=" form1 col-md-offset-4 col-md-4 col-sm-offset-3 col-sm-6">
					<h3 class="form2"> WELCOME ADMIN <br> Connect to your Safe Account </h3> 
					...
					<form enctype="multipart/form-data"  method="post"  action="TraitementConnexionAdmin.php"  id="myform" style="margin-top: 20px; margin-bottom: 10px;">
